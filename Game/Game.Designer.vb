...
Partial Class frmGame
    ...
    Private Sub InitializeComponent()
        ...
        Me.tmrSpawnDelay = New System.Windows.Forms.Timer(Me.components)
        Me.SuspendLayout()
        '
        'tmrUpdate
        '
        ...
        'tmrDelay1
        '
        Me.tmrDelay1.Interval = 1750
        '
        'tmrSpawnDelay
        '
        Me.tmrSpawnDelay.Interval = 1000
        '
        'frmGame
        '
    ...
    Friend WithEvents tmrSpawnDelay As System.Windows.Forms.Timer
